...
<section class="container">
					...
					<table cellpadding="10px;" border="1" id="test_list">
                        ...
                        <tbody>
							...
							<tr class="odd">
                                ...
                                <td><a href="#" class="profile-hover">John Rushing</a></td>
                                <td>145822</td>
                                <td><a href="#" class="start-test" title="START TEST"></a> <a href="#" class="detail-test" id="td-6" data-panel="close"></a></td>
                            </tr>
							<tr class="odd">
                               	<td><a href="#">#125485</a></td>
                                <td><a href="#" class="subj_2_cat">Programing</a></td>
                                ...
                                <td><a href="#" class="profile-hover">John Rushing</a></td>
                                <td>145822</td>
                                <td><a href="#" class="start-test" title="START TEST"></a> <a href="#" class="detail-test" id="td-7" data-panel="close"></a></td>
                            </tr>
    ...
    $(document).ready(function () {
        $("a.detail-test").on("click", function (){
            var $this=$(this);
            var tr_index=$this.attr("data-index");
            var tr_add='<tr><td colspan="7"><div class="test_detail_container"></div></td></tr>';
            $('#test_list > tbody > tr').eq(tr_index-1).after(tr_add);
            $(".test_detail_container").animate({height:350},500);
        });   
    });
    </script>
</body>
