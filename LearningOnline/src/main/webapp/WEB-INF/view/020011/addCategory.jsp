...
<head>
	...
	<input type="text" id="operationId"/>
		...
		$.ajax({
 			...
 			success:function(response){
 				if(response.status=="SUCCESS"){
 					...
 					if(key==1){
 	 						requestListById('requestAllCategory',"GET",'',$("ul#"+elementId),0,elementId,1);	
 	 				}else{
 	 						requestListById('requestAllCategory',"GET",'',$("ul#"+elementId),whereId,elementId,key);			
 	 				}	
 				}
