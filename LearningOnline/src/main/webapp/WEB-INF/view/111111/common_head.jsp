            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse navbar-right">
                     <ul class="nav navbar-nav padding512">
                        ...
                        <li><a href="redirectHome">DEMO</a></li>
                        <li><a href="redirectGroupHome">GROUP</a></li>
                        <li><a href="redirectQATerminal">QA TERMINAL</a></li>
                        <li><a href="preAccessLogin">LOGIN</a></li>
                    </ul>
                </div>
                                <nav class="menu">
                   <div class="navbar-header">
