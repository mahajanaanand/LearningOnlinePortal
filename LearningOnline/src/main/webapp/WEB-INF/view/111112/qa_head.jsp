            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse navbar-right">
                     <ul class="nav navbar-nav padding512">
						...
						<li><a href="QA_Ask_A_Question.html">ASK A QUESTION</a></li>
                        <li><a href="QA_Unanswered_Question.html">UNANSWERED QUESTION</a></li>
                        <li><a href="preAccessLogin.html">LOGIN</a></li>
                    </ul>
                </div>
                                <nav class="menu">
                   <div class="navbar-header">
